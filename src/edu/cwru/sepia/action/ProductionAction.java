...
/**
 * A sub-type of Action that includes CompoundProduction, PrimitiveProduction, and PrimitiveBuild.
 * In addition to the base attributes found in Action, this class also includes a template Id that 
 * represents the {@code edu.cwru.sepia.model.state.UnitTemplate} off of which the new 
 * unit will be based. Unlike with {@code LocationProductionAction}, the location in which the new
 * unit spawns will be determined by the model.
 *
 */
