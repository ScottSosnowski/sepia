...
public final class TypeLoader {
	...
	public static List<Template<?>> loadFromFile(String filename, int player, IdDistributor idsource) throws FileNotFoundException, JSONException {
...
//				System.out.println(template.getName() + " requires building: " + reqs.getString(i));
	...
	private static UnitTemplate handleUnit(JSONObject obj, int player, IdDistributor idsource) throws JSONException {
	...
	private static UpgradeTemplate handleUpgrade(JSONObject obj, int player, IdDistributor idsource) throws JSONException {
