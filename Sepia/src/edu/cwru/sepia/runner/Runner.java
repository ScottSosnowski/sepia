...
public abstract class Runner {
	 ...
	 */
	protected void saveAgentData(File directory, int agentIndex) throws IOException {
	 ...
	 * @throws IOException 
	 */
	protected void saveAgentData(File file, Agent agent) throws IOException {
		FileOutputStream fos = new FileOutputStream(file);
		agent.savePlayerData(fos);
		fos.close();
	}
	/**
	 ...
	 * @throws IOException 
	 */
	protected void loadAgentData(File directory, int agentIndex) throws IOException {
		loadAgentData(new File(directory, "agent"+agentIndex+".agt"), agents[agentIndex]);
	}
	protected void loadAgentData(File file, Agent agent) throws IOException {
		FileInputStream fis = new FileInputStream(file);
		agent.loadPlayerData(fis);
		fis.close();
	}
	/**
	...
	protected void saveHistory(File file, History history) {
		SerializerUtil.storeHistory(file.getAbsolutePath(), history);
	}
	/**
	...
	protected void saveState(File file, State state) {
		SerializerUtil.storeState(file.getAbsolutePath(), state);
	}
}
