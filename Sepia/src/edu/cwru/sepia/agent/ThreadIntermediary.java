...
public class ThreadIntermediary implements Runnable {
	...
	private Collection<Action> submittedActions;
	...
	public synchronized void submitActions(Collection<Action> actions)
	{
		submittedActions = actions;
		actionLatch.countDown();
	}
	public synchronized Collection<Action> retrieveActions()
	{
