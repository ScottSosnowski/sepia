...
public class State implements Serializable, Cloneable, IdDistributor {
	...
	public int hashCode() {
		...
		result = prime * result + worldBuilder.hashCode();
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (worldBuilder == null) {
			if (other.worldBuilder != null)
				return false;
		} else if (!worldBuilder.equals(other.worldBuilder))
			return false;
		return true;
	}
	/**
 ...
 * *************************************************/
	...
	public void addTemplate(Template t) {
		...
		if (!playerStates.containsKey(player))
			addPlayer(player);
		if(!allTemplates.containsKey(t.getID())) {
			PlayerState playerState = playerStates.get(player);
			if(playerState == null)
			{
