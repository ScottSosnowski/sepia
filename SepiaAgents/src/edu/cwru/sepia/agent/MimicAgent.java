...
public class MimicAgent extends Agent {
	...
	private Map<Integer,? extends Collection<Action>> actions;
	/**
	 ...
	 */
	public MimicAgent(int player, Map<Integer,? extends Collection<Action>> actions) {
		super(player);
		this.actions = actions;
	}

	@Override
	public Collection<Action> initialStep(StateView newstate,
			HistoryView statehistory) {
		return pullActionFromMemory(newstate);
	}

	@Override
	public Collection<Action> middleStep(StateView newstate,
			HistoryView statehistory) {
		return pullActionFromMemory(newstate);
	}

	private Collection<Action> pullActionFromMemory(StateView state) {
